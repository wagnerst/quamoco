...
public class ShowTwoHierarchySunburstAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			TwoHierarchySunburstView view = (TwoHierarchySunburstView) PlatformUI
					.getWorkbench()
					.getActiveWorkbenchWindow()
					.getActivePage()
					.showView(TwoHierarchySunburstView.ID,
