...
public class ShowKiviatAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			KiviatView view = (KiviatView) PlatformUI
					.getWorkbench()
					.getActiveWorkbenchWindow()
					.getActivePage()
					.showView(KiviatView.ID, getId(),
	...
	public void selectionChanged(IAction action, ISelection selection) {
		results = SelectionUtils.checkAndSelectAll(selection,
