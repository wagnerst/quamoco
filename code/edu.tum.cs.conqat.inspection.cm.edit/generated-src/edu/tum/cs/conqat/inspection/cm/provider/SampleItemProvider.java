 ...
 * </copyright>
 *
 * $Id: SampleItemProvider.java 4974 2012-02-17 09:34:10Z lochmann $
 */
...
/**
 * This is the item provider adapter for a {@link edu.tum.cs.conqat.inspection.cm.Sample} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CmPackage.Literals.SAMPLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPackagePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sample_packagePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sample_packagePath_feature", "_UI_Sample_type"),
				 CmPackage.Literals.SAMPLE__PACKAGE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSourcePathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sample_sourcePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sample_sourcePath_feature", "_UI_Sample_type"),
				 CmPackage.Literals.SAMPLE__SOURCE_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLineNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sample_lineNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sample_lineNumber_feature", "_UI_Sample_type"),
				 CmPackage.Literals.SAMPLE__LINE_NUMBER,
				 true,
				 false,
				 false,
	...
	protected void addSourceStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sample_sourceStart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sample_sourceStart_feature", "_UI_Sample_type"),
				 CmPackage.Literals.SAMPLE__SOURCE_START,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addSourceEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sample_sourceEnd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sample_sourceEnd_feature", "_UI_Sample_type"),
				 CmPackage.Literals.SAMPLE__SOURCE_END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
