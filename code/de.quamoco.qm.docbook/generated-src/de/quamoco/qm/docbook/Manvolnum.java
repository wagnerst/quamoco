 ...
 *       &lt;group ref="{}word.char.mix" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;attGroup ref="{}manvolnum.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "manvolnum")
public class Manvolnum {

    @XmlElementRefs({
        @XmlElementRef(name = "acronym", type = JAXBElement.class),
