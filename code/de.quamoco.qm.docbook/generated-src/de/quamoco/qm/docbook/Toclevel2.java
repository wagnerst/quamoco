 ...
 *       &lt;sequence>
 *         &lt;element ref="{}tocentry" maxOccurs="unbounded"/>
 *         &lt;element ref="{}toclevel3" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}toclevel2.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "toclevel2")
public class Toclevel2 {

    @XmlElement(name = "tocentry", required = true)
    protected List<Tocentry> tocentries;
    @XmlElement(name = "toclevel3")
    protected List<Toclevel3> toclevel3S;
    ...
    /**
     * Gets the value of the toclevel3S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the toclevel3S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getToclevel3s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Toclevel3> getToclevel3s() {
        if (toclevel3S == null) {
            toclevel3S = new ArrayList<Toclevel3>();
        }
        return this.toclevel3S;
    }
