 ...
 *         &lt;element ref="{}tocchap" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}tocpart.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Tocpart {
    ...
    /**
     * Gets the value of the tocchaps property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tocchaps property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTocchaps().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Tocchap> getTocchaps() {
        if (tocchaps == null) {
            tocchaps = new ArrayList<Tocchap>();
        }
        return this.tocchaps;
    }
