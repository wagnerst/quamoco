 ...
 *       &lt;sequence>
 *         &lt;element ref="{}indexterm" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}itermset.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "itermset")
public class Itermset {

    @XmlElement(name = "indexterm", required = true)
    protected List<NdxTerm2Type> indexterms;
     ...
     * 
     */
    public List<NdxTerm2Type> getIndexterms() {
        if (indexterms == null) {
            indexterms = new ArrayList<NdxTerm2Type>();
        }
