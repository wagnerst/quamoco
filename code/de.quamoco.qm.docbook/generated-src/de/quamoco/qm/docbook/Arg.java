...
public class Arg {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "group", type = Group.class),
        @XmlElementRef(name = "arg", type = Arg.class),
        @XmlElementRef(name = "sbr", type = Sbr.class),
        @XmlElementRef(name = "synopfragmentref", type = Synopfragmentref.class),
        @XmlElementRef(name = "option", type = JAXBElement.class),
