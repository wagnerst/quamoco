 ...
 *         &lt;element ref="{}toclevel4" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}toclevel3.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Toclevel3 {
    ...
    /**
     * Gets the value of the toclevel4S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the toclevel4S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getToclevel4s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Toclevel4> getToclevel4s() {
        if (toclevel4S == null) {
            toclevel4S = new ArrayList<Toclevel4>();
        }
        return this.toclevel4S;
    }
