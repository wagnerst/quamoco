 ...
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}partintro.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Partintro {
    ...
    protected List<JAXBElement<SectionClass>> sectionClass;
    @XmlElement(name = "simplesect")
    protected List<Simplesect> simplesects;
    @XmlElementRef(name = "refentry.class", type = JAXBElement.class)
    protected List<JAXBElement<RefentryClass>> refentryClass;
    @XmlElement(name = "sect1")
    protected List<Sect1> sect1S;
    @XmlAttribute
    ...
    /**
     * Gets the value of the sectionClass property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sectionClass property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSectionClass().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<SectionClass>> getSectionClass() {
        if (sectionClass == null) {
            sectionClass = new ArrayList<JAXBElement<SectionClass>>();
        }
        return this.sectionClass;
    }

    /**
     * Gets the value of the simplesects property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the simplesects property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSimplesects().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Simplesect> getSimplesects() {
        if (simplesects == null) {
            simplesects = new ArrayList<Simplesect>();
        }
        return this.simplesects;
    }

    /**
     * Gets the value of the refentryClass property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the refentryClass property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRefentryClass().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<RefentryClass>> getRefentryClass() {
        if (refentryClass == null) {
            refentryClass = new ArrayList<JAXBElement<RefentryClass>>();
        }
        return this.refentryClass;
    }

    /**
     * Gets the value of the sect1S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sect1S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSect1s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Sect1> getSect1s() {
        if (sect1S == null) {
            sect1S = new ArrayList<Sect1>();
        }
        return this.sect1S;
    }
