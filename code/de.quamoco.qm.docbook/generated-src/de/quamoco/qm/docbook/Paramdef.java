...
@XmlRootElement(name = "paramdef")
public class Paramdef {

    @XmlElementRefs({
        @XmlElementRef(name = "funcparams", type = Funcparams.class),
        @XmlElementRef(name = "parameter", type = JAXBElement.class),
        @XmlElementRef(name = "initializer", type = Initializer.class),
