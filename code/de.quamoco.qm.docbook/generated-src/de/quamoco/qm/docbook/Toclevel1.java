 ...
 *         &lt;element ref="{}toclevel2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}toclevel1.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Toclevel1 {
    ...
    /**
     * Gets the value of the toclevel2S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the toclevel2S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getToclevel2s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Toclevel2> getToclevel2s() {
        if (toclevel2S == null) {
            toclevel2S = new ArrayList<Toclevel2>();
        }
        return this.toclevel2S;
    }
