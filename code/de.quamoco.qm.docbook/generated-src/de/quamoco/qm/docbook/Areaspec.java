...
@XmlRootElement(name = "areaspec")
public class Areaspec {

    @XmlElements({
        @XmlElement(name = "area", type = Area.class),
        @XmlElement(name = "areaset", type = Areaset.class)
    })
    protected List<Object> areasAndAreasets;
    @XmlAttribute
     ...
     * This is why there is not a <CODE>set</CODE> method for the areasAndAreasets property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAreasAndAreasets().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAreasAndAreasets() {
        if (areasAndAreasets == null) {
            areasAndAreasets = new ArrayList<Object>();
        }
        return this.areasAndAreasets;
    }
