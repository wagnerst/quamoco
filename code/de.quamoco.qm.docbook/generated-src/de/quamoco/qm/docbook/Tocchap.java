 ...
 *         &lt;element ref="{}toclevel1" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}tocchap.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Tocchap {
    ...
    /**
     * Gets the value of the toclevel1S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the toclevel1S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getToclevel1s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Toclevel1> getToclevel1s() {
        if (toclevel1S == null) {
            toclevel1S = new ArrayList<Toclevel1>();
        }
        return this.toclevel1S;
    }
