 ...
 *         &lt;element ref="{}toclevel5" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}toclevel4.attlist"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Toclevel4 {
    ...
    /**
     * Gets the value of the toclevel5S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the toclevel5S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getToclevel5s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Toclevel5> getToclevel5s() {
        if (toclevel5S == null) {
            toclevel5S = new ArrayList<Toclevel5>();
        }
        return this.toclevel5S;
    }
