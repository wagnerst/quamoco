...
import de.quamoco.adaptation.model.FeatureRequired;

import de.quamoco.adaptation.model.status.provider.FulfillmentCriterionItemProvider;
...
/**
 * This is the item provider adapter for a {@link de.quamoco.adaptation.model.FeatureRequired} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureRequiredItemProvider
	extends FulfillmentCriterionItemProvider
	implements
	 ...
	 * @generated
	 */
	public FeatureRequiredItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns FeatureRequired.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureRequired"));
	}
	...
	public String getText(Object object) {
		String label = ((FeatureRequired)object).getFeatureName();
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureRequired_type") :
			getString("_UI_FeatureRequired_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeatureRequired.class)) {
			case AdaptationModelPackage.FEATURE_REQUIRED__FEATURE:
			case AdaptationModelPackage.FEATURE_REQUIRED__FEATURE_NAME:
			case AdaptationModelPackage.FEATURE_REQUIRED__REFERENCE_TYPE:
			case AdaptationModelPackage.FEATURE_REQUIRED__OTHER_ELEMENT_TYPE:
			case AdaptationModelPackage.FEATURE_REQUIRED__OTHER_ELEMENT_TYPE_NAME:
			case AdaptationModelPackage.FEATURE_REQUIRED__ELEMENT_TYPE:
