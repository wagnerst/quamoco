...
/**
 * This is the item provider adapter for a {@link de.quamoco.adaptation.model.Purpose} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PurposeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AdaptationModelPackage.Literals.PURPOSE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Purpose_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Purpose_description_feature", "_UI_Purpose_type"),
				 AdaptationModelPackage.Literals.PURPOSE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AdaptationModelPackage.Literals.PURPOSE__PURPOSE_ACTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Purpose.class)) {
			case AdaptationModelPackage.PURPOSE__NAME:
			case AdaptationModelPackage.PURPOSE__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case AdaptationModelPackage.PURPOSE__PURPOSE_ACTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AdaptationModelPackage.Literals.PURPOSE__PURPOSE_ACTIONS,
				 AdaptationModelFactory.eINSTANCE.createRemoveTypeAction()));
	}
