 ...
 * @version $Rev: 4974 $
 * @levd.rating YELLOW Hash: 378A2AA5410F699371E6E94FF0F2A1B3
 */
public class FactorRefinedByDirectSection extends
		OppositeReferencePropertySectionBase {

	/** Constructor. */
	public FactorRefinedByDirectSection() {
		super(QmPackage.eINSTANCE.getFactor_RefinesDirect(), "Refined By");
	}
}
