 ...
 */
@AConQATProcessor(description = "Calculates the number of source statements for each class.")
public class NumberOfSourceStatementsCounter extends JavaAnalyzerBase {

	/** Key for messages. */
	@AConQATKey(description = "Number of Source Statements in Class", type = "java.lang.Integer")
	public static final String METHOD_COUNT_KEY = "#Statements";
	...
	protected void analyze(IJavaElement classElement, JavaClass clazz) {
		...
		classElement.setValue(METHOD_COUNT_KEY,
				ast.findChildrenOfType(ASTStatement.class).size());
	}

	/** {@inheritDoc} */
	@Override
	protected String[] getKeys() {
		return new String[] { METHOD_COUNT_KEY };
	}
}