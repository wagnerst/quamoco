...
import de.quamoco.qm.diagram.edit.parts.QmEditPartFactory;
 ...
 * @generated
 */
public class QmEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public QmEditPartProvider() {
		setFactory(new QmEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!QualityModelEditPart.MODEL_ID.equals(QmVisualIDRegistry
					.getModelID(view))) {
				return false;
			}
