...
import de.quamoco.qm.diagram.part.QmDiagramEditor;
 ...
 * @generated
 */
public class QmNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof QmNavigatorItem) {
					selectedElement = ((QmNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, QmDiagramEditor.ID);
