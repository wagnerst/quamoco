 ...
 * @generated
 */
public class FactorRefinementReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FactorRefinementReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof FactorRefinement) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		Factor target = getLink().getParent();
		...
		return QmBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactorRefinement_4010(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Factor source = getLink().getChild();
		if (!(getLink().eContainer() instanceof Factor)) {
			return false;
		}
		Factor container = (Factor) getLink().eContainer();
		return QmBaseItemSemanticEditPolicy.LinkConstraints
				.canExistFactorRefinement_4010(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected FactorRefinement getLink() {
		return (FactorRefinement) getElementToEdit();
	}
