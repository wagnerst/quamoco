 ...
 * @generated
 */
public class QmEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case QualityModelEditPart.VISUAL_ID:
				return new QualityModelEditPart(view);

			case FactorEditPart.VISUAL_ID:
				return new FactorEditPart(view);

			case FactorQualifiedNameEditPart.VISUAL_ID:
				return new FactorQualifiedNameEditPart(view);
			...
			case FactorRefinementEditPart.VISUAL_ID:
				return new FactorRefinementEditPart(view);

			case ImpactEditPart.VISUAL_ID:
				return new ImpactEditPart(view);

			case SpecializationEditPart.VISUAL_ID:
				return new SpecializationEditPart(view);
