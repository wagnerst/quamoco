 ...
 * </copyright>
 *
 * $Id: ImpactItemProvider.java 4974 2012-02-17 09:34:10Z lochmann $
 */
...
/**
 * This is the item provider adapter for a {@link de.quamoco.qm.Impact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImpactItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_source_feature", "_UI_Impact_type"),
				 QmPackage.Literals.IMPACT__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_target_feature", "_UI_Impact_type"),
				 QmPackage.Literals.IMPACT__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEffectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_effect_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_effect_feature", "_UI_Impact_type"),
				 QmPackage.Literals.IMPACT__EFFECT,
				 true,
				 false,
				 false,
	...
	protected void addJustificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_justification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_justification_feature", "_UI_Impact_type"),
	...
	public Object getImage(Object object) {
		Impact impact = (Impact) object;
		Effect effect = impact.getEffect();
		String image = "Impact";
		if (effect != null) {
			image += effect.getName();
		}

		return overlayImage(impact, this.getImage("full/obj16/" + image));
	}
	...
	public String getText(Object object) {
		Impact impact = (Impact) object;
		return impact.getQualifiedName();
	}
