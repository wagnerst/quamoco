...
public class ContributionPointsEditingSupport extends AbstractEditingSupport {

	public ContributionPointsEditingSupport(TableViewer viewer) {
		super(
				viewer,
	...
	protected void setValue(InfluencingOrRefiningElement<?> element,
		...
		if (newValue >= 0) {
			element.setContPoints(newValue);
		}
	}
